...
- **Date:** 2026-01-13
- **URL:** https://dang.ai
- **Status:** Submitted (check email for next steps)
...
- **Status:** Already submitted (duplicate detected)

## Dev Hunt
- **Date:** 2026-01-14
- **URL:** https://devhunt.org
- **Status:** Already submitted (in queue)

## Uneed
- **Date:** 2026-01-14
- **URL:** https://www.uneed.best/submit-a-tool
- **Status:** Account created (pending email verification to complete submission)

## BetaList
- **Date:** 2026-01-14
- **URL:** https://betalist.com/submit
- **Status:** Attempted - form filled but icon upload has content type issues (requires manual icon upload)

## StartupBase
- **Date:** 2026-01-14
- **URL:** https://startupbase.io
- **Status:** Not available - signups currently closed

## AlternativeTo
- **Date:** 2026-01-14
- **URL:** https://alternativeto.net
- **Status:** Attempted - Google sign up blocked, needs manual account creation

## SaaS AI Tools
- **Date:** 2026-01-14
- **URL:** https://saasaitools.com
- **Status:** Attempted - requires account creation (signup form at /join)

## CrozDesk
- **Date:** 2026-01-14
- **URL:** https://crozdesk.com
- **Status:** Not available - no vendor submission page found (404 on /vendors)

## Crunchbase
- **Date:** 2026-01-14
- **URL:** https://www.crunchbase.com
- **Status:** Attempted - requires account to add new companies

## SoftwareWorld
- **Date:** 2026-01-14
- **URL:** https://softwareworld.co
- **Status:** Attempted - requires account creation with CAPTCHA

## F6S
- **Date:** 2026-01-14
- **URL:** https://f6s.com
- **Status:** Attempted - requires email verification code (sent to thereactdev@gmail.com)

## Read.cv
- **Date:** 2026-01-14
- **URL:** https://read.cv
- **Status:** Not available - deployment temporarily paused

## Indie Hackers
- **Date:** 2026-01-14
- **URL:** https://indiehackers.com
- **Status:** Attempted - signup form has complex dropdowns, partially filled (username: humanloopquest, selected AI category)

## Product Hunt
- **Date:** 2026-01-14
- **URL:** https://producthunt.com
- **Status:** Submitted - scheduled for launch (Pre-launch dashboard active)

## Hacker News (Show HN)
- **Date:** 2026-01-14
- **URL:** https://news.ycombinator.com/showhn
- **Status:** Attempted - requires account creation (cannot create accounts automatically)

## Toolfolio
- **Date:** 2026-01-14
- **URL:** https://toolfolio.io
- **Status:** Not available - paid marketplace only (no free submissions)

## OpenAlternative
- **Date:** 2026-01-14
- **URL:** https://openalternative.co/submit
- **Status:** Requires authentication - redirects to login page (needs Google sign-in)

## Insanely Cool Tools
- **Date:** 2026-01-14
- **URL:** https://insanelycooltools.com/submit
- **Status:** Not available - domain parked/inactive (redirects to SearchHounds)
...
- **Status:** Already submitted (duplicate detected - URL already added to directory)

## Tool Summary
- **Date:** 2026-01-14
- **URL:** https://toolsummary.com/submit-ai-tool/
- **Status:** Submitted (pending approval - confirmation message shown on page)
